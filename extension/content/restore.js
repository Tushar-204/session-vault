// Relays "restore tabs" requests from the SessionVault web app to the background
// service worker, which opens each URL via chrome.tabs.create (no popup blocking).
